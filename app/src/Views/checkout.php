                                ...
                                <?php if (!empty($requires_details)): ?>
                                    ...
                                    <form method="post" action="/checkout/details" class="row g-3">
                                        ...
                                        <div class="col-12 d-grid">
                                            <button type="submit" class="btn cta-btn">Continue to payment</button>
                                        </div>
                                    </form>
                                <?php else: ?>
                                    <h2 class="h5 mb-2">Review & pay</h2>
                                    <p class="text-muted small mb-3">Tickets are reserved for 10 minutes while we prepare your payment.</p>
